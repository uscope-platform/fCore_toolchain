...
TEST( hl_pretty_print, expression){
    ...
    std::shared_ptr<hl_expression_node> gold_standard = std::make_shared<hl_expression_node>(hl_expression_node::ADD);
...
TEST( hl_pretty_print, function_def){
    ...
    std::shared_ptr<hl_expression_node> exp = std::make_shared<hl_expression_node>(hl_expression_node::MULT);
    var = std::make_shared<variable>("constant", 5);
    std::shared_ptr<hl_ast_operand> op_l = std::make_shared<hl_ast_operand>(var);
    var = std::make_shared<variable>("constant", 6);
    std::shared_ptr<hl_ast_operand> op_r = std::make_shared<hl_ast_operand>(var);
    ...
    exp = std::make_shared<hl_expression_node>(hl_expression_node::MULT);
    var = std::make_shared<variable>("constant", 7);
...
TEST(hl_pretty_print, complex_expression) {
    ...
    auto e_add = std::make_shared<hl_expression_node>(hl_expression_node::ADD);
    ...
    auto e_mul = std::make_shared<hl_expression_node>(hl_expression_node::MULT);
    e_mul->set_rhs(e_add);
    var = std::make_shared<variable>("constant", 3.3f);
    op = std::make_shared<hl_ast_operand>(var);
    e_mul->set_lhs(op);

    auto e_div = std::make_shared<hl_expression_node>(hl_expression_node::DIV);
    e_div->set_lhs(e_mul);
