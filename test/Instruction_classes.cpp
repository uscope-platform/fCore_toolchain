...
TEST(InstructionClasses, immediate_instruction ) {
    ...
    ll_instruction instr(IMMEDIATE_INSTRUCTION,"ldr", args);
...
TEST(InstructionClasses, register_instruction ) {
    ...
    ll_instruction instr(REGISTER_INSTRUCTION,"add", args);
...
TEST(InstructionClasses, independent_instruction ) {
    ...
    ll_instruction instr(INDEPENDENT_INSTRUCTION,"stop", args);
