...
TEST(emulator_manager_v2, emulator_disassemble_common_io) {
    ...
    EXPECT_EQ(res["test"].translation_table, expected["test"].translation_table);
    EXPECT_EQ(res["test"].common_io_translation_table, expected["test"].common_io_translation_table);
