...
TEST( EndToEndAsm, compare_file ) {
    ...
    std::vector<uint32_t> gold_standard = {0x90001,0xc, 0xc, 0x86, 0x42c80000, 0xc2881, 0x8006E, 0x21848, 0x21849, 0x2184a, 0x2184b, 0xC};
    ASSERT_EQ( result, gold_standard);
}
...
TEST(EndToEndAsm, load_constant_file) {
    ...
    std::vector<uint32_t> gold_standard = {0x70001,0xc, 0xc, 0x86, 0x42c80000, 0xa6, 0x43480000, 0x86, 0x4048f5c3, 0xc};
    ASSERT_EQ( result, gold_standard);
}
...
TEST(EndToEndAsm, load_integer_constant) {
    ...
    std::vector<uint32_t> gold_standard = {0x30001,  0xc, 0xc,0x86, 0x64, 0xc};
    ASSERT_EQ( result, gold_standard);
}
