...
TEST(EndToEndC, loop_index_expression) {
    ...
    std::vector<uint32_t> gold_standard = {0x70005, 0xc,0x10032,0x20033, 0x3003C, 0x5003d, 0xc,  0xc, 0x66, 0, 0x86, 0x0, 0xa0881, 0xa10a1, 0xc};
...
TEST(EndToEndC, loop_index_expression_multidim) {
    ...
    std::vector<uint32_t> gold_standard = {0x70005, 0xc, 0x20031,0x10035, 0x3003c, 0x5003d, 0xc, 0xc, 0x66, 0, 0x86, 0x0, 0xa1081, 0xa08a1, 0xc};
...
TEST(EndToEndC, avoid_commutative_constant_evaluation) {
    ...
    std::vector<uint32_t> gold_standard = {0x70002, 0xc, 0x1000A, 0xc, 0xc, 0x46, 0x40e00000, 0x60842, 0x26, 0x40a00000, 0x41823, 0xc};
...
TEST(EndToEndC, add_commutative_constant_evaluation) {
    ...
    std::vector<uint32_t> gold_standard = {0x40002, 0xc, 0x1000A, 0xc, 0xc, 0x46, 0x41400000, 0x61021, 0xc};
...
TEST(EndToEndC, csel_crash) {
    ...
    std::vector<uint32_t> gold_standard = {0x40005, 0xc, 0x2000C, 0x3000D, 0x1000E, 0x10032, 0xc, 0xc, 0x8002b, 0x6109b, 0x2008e, 0xc};
...
TEST(EndToEndC, multi_csel_wrong_condition) {
    ...
    std::vector<uint32_t> gold_standard = {0x70006, 0xc,
        ...
        0xc, 0xc,
        0x8002b, 0x2008e, 0x6103b, 0x4002e, 0x6009b, 0x2008e,
        0xc};
...
TEST(EndToEndC, conditional_cselization) {
    ...
    std::vector<uint32_t> gold_standard = {0xC0007, 0xc, 0x1000C, 0x2000D, 0x3000E, 0x10032, 0x3e0033, 0x3f0034, 0xc, 0xc,
        0x8006a, 0x66, 0x42520000, 0xa008e,  0x7f8bb, 0x7e00ae, 0xa008e, 0x7c18bb, 0x7c00ae, 0x2109b, 0x2008e, 0xc};
...
TEST(EndToEndC, ternary_in_if) {
    ...
    std::vector<uint32_t> gold_standard = {0x60006, 0xc, 0x3000C, 0x4000D, 0x2000E, 0x1000f, 0x20032, 0xc, 0xc,
        0xa002b, 0x818bb, 0x2004a, 0xa203b, 0x4002e, 0xc};
