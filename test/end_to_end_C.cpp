...
TEST(EndToEndC, end_to_end_intrinsics) {
    ...
    std::vector<uint32_t> gold_standard = {0x80002, 0xc, 0x1000A, 0xc, 0xc, 0x1024,0x46,0x42C80000,0, 0x61030, 0x1033, 0x2f836, 0xc};
    ASSERT_EQ(result, gold_standard);
}
...
TEST(EndToEndC, efi_load_elimination) {
    ...
    std::vector<uint32_t> gold_standard = {0xE0004, 0xc, 0x10001, 0x1000f, 0x20011,  0xc, 0xc, 0x6002e,
                                           0x46, 0x0, 0, 0x21055, 0x46,0x38000074, 0, 0x20843, 0x46, 0x1, 0, 0x41055,0xc};
...
TEST(EndToEndC, efi_load_elimination_in_func) {
    ...
    std::vector<uint32_t> gold_standard = {0x180004, 0xc, 0x10001, 0x2000f, 0x30011, 0xc, 0xc, 0x46, 0x0, 0x6002e, 0x81055,
                                           0x2084, 0x46,0x38000074, 0, 0, 0, 0x82043, 0, 0, 0, 0, 0, 0, 0x4008e,
...
TEST(EndToEndC, test_ternary_operator) {
    ...
    std::vector<uint32_t> gold_standard = {0xC0003, 0xc, 0x30002, 0x10003, 0xc, 0xc, 0x40028, 0x26, 0x43160000, 0x66,  0x43480000, 0, 0x6085b, 0x26, 0x42000000,0, 0x60842, 0xc};
...
TEST(EndToEndC, ternary_in_if) {
    ...
    std::vector<uint32_t> gold_standard = {0xA0006, 0xc, 0x3000C, 0x4000D, 0x2000E, 0x1000f, 0x20032, 0xc, 0xc,
        0xa002b, 0, 0x818bb, 0x2004a, 0, 0xa203b, 0, 0, 0x4002e, 0xc};
