...
TEST(EndToEndC, iom) {
    ...
    std::vector<uint32_t> gold_standard = {0x80005, 0xc, 0x3f0001,0x10002, 0x3e0004, 0x3000A, 0xc, 0xc, 0x7c0fe1, 0x26, 0x40A00000, 0x40fc3, 0x26, 0x3e2aaaab, 0x60843, 0xc};
...
TEST(EndToEndC, array_io_definition) {
    ...
    std::vector<uint32_t> gold_standard = {0x60008, 0xc,0x30003,0x10004,0x20007,0x40008,0x50009,0x3f000A,0x3e000B,
                                           0xc, 0xc, 0x61021, 0x81021, 0xa1022, 0x7e1023, 0x7c1823, 0xc};
...
TEST(EndToEndC, multidimensional_array_io_definition) {
    ...
    std::vector<uint32_t> gold_standard = {0xA000B,  0xc, 0x10004, 0x20007, 0x40008, 0x60009, 0x5000A, 0x7000B,
                                           ...
                                           0xc1021, 0xe1022, 0x7e1023, 0x7a1823, 0x7c1023, 0x781823, 0xc};
...
TEST(EndToEndC, test_complex_normalization){
    ...
    std::vector<uint32_t> gold_standard = {0x90004, 0xc, 0x10001,0x20002,0x3f000a, 0xc, 0xc, 0x66, 0x40A00000, 0x81841, 0x46, 0x41880000, 0x61023, 0x22063, 0x7e0fe1, 0xc};
...
TEST(EndToEndC, function_inlining_expression) {
    ...
    std::vector<uint32_t> gold_standard = {
        0xC0003, 0xc,  0x3f0006, 0x10019, 0xc, 0xc, 0x46, 0x3851B717, 0x61023,
        0x21fe1, 0x46, 0xC3160000, 0x21031, 0x46,
...
TEST(EndToEndC, test_constant_propagation) {
    ...
    std::vector<uint32_t> gold_standard = {0x50004, 0xc, 0x10005, 0x3e0011,0x3D0012,  0xc, 0xc,
                                           0x7e6,0x3F800000, 0x7c0fe1, 0x7a0fe1, 0xc};
...
TEST(EndToEndC, negative_leading_sum) {
    ...
    std::vector<uint32_t> gold_standard = {0x30004, 0xc,0x10002,0x20003, 0x10007, 0xc, 0xc, 0x60802, 0x21063, 0xc};
...
TEST(EndToEndC, function_vars_mangling) {
    ...
    std::vector<uint32_t> gold_standard = { 0x90004, 0xc,0x10001,  0x20002,0x3000A ,0xc, 0xc, 0x66, 4, 0x81843, 0x46, 2, 0x61023, 0x41881, 0x60841, 0xc};
