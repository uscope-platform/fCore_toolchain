...
TEST(EndToEndC, iom) {
    ...
    std::vector<uint32_t> gold_standard = {0x80005, 0xc,0x3000A,0x3f0004, 0x10002, 0x3e0001, 0xc, 0x7e0fc1, 0x26, 0x40A00000, 0x40fe3, 0x26, 0x3e2aaaab, 0x60843, 0xc};
...
TEST(EndToEndC, loop) {
    ...
    std::vector<uint32_t> gold_standard = {0x30007, 0xc, 0x20007, 0x40008, 0x30003, 0x10004, 0x5000B, 0x2000c, 0xc, 0xa1061, 0x42021, 0xc};
...
TEST(EndToEndC, nested_loop) {
    ...
    std::vector<uint32_t> gold_standard = { 0x50007, 0xc, 0x30003, 0x10004, 0x5000B, 0x3000c, 0x20005, 0x40006, 0xc, 0xa1061, 0xa2061, 0x61021, 0x62021, 0xc};
...
TEST(EndToEndC, array_io_definition) {
    ...
    std::vector<uint32_t> gold_standard = {0x60008, 0xc, 0x40008,0x50009,0x30003,0x3e000A,0x3f000B,0x10004,0x20007,
...
TEST(EndToEndC, multidimensional_array_io_definition) {
    ...
    std::vector<uint32_t> gold_standard = {0xA000B,  0xc, 0x40008, 0x60009, 0x5000A, 0x7000B,
                                           0x3d000C, 0x3E000D, 0x3c0010,0x3f0012, 0x10004, 0x20007, 0xc, 0x61021, 0x81021, 0xa1022,
...
TEST(EndToEndC, test_move){
    ...
    std::vector<uint32_t> gold_standard = {0x20003, 0xc, 0x2000a, 0x10001, 0xc, 0x40021, 0xc};
...
TEST(EndToEndC, test_complex_normalization){
    ...
    std::vector<uint32_t> gold_standard = {0x90004, 0xc, 0x3f000a,0x10002,0x20001, 0xc, 0x66, 0x40A00000, 0x81821, 0x26, 0x41880000, 0x60843, 0x22063, 0x7e0fe1, 0xc};
...
TEST(EndToEndC, register_allocation){
    ...
    std::vector<uint32_t> gold_standard = {0x40003, 0xc, 0x3f000a, 0x10001, 0xc, 0x46, 0x41880000, 0x7e1023, 0xc};
...
TEST(EndToEndC, function_inlining_expression) {
    ...
    std::vector<uint32_t> gold_standard = {0xF0003, 0xc, 0x10019, 0x3f0006, 0xc, 0x46, 0x40A00000, 0x61023, 0x26, 0x3727C5AC, 0x41823, 0x217e1, 0x46, 0xC3160000, 0x21031, 0x46, 0x43160000, 0x21030, 0x40021, 0xc};
...
TEST(EndToEndC, essential_variable_initialization) {
    ...
    std::vector<uint32_t> gold_standard = {0x80005, 0xc,0x50007, 0x10005,0x10019,0x30006, 0xc, 0x46, 0x3F800000,
...
TEST(EndToEndC, test_constant_propagation) {
    ...
    std::vector<uint32_t> gold_standard = {0x50004, 0xc,  0x3e0011,0x3f0012, 0x10005, 0xc,
...
TEST(EndToEndC, negative_leading_sum) {
    ...
    std::vector<uint32_t> gold_standard = {0x30004, 0xc,0x20007,0x10003, 0x20002, 0xc, 0x61002, 0x40863, 0xc};
...
TEST(EndToEndC, function_vars_mangling) {
    ...
    std::vector<uint32_t> gold_standard = { 0x90004, 0xc,0x3000A,  0x10002, 0x20001,0xc, 0x66, 4, 0x81823, 0x26, 2, 0x60843, 0x21881, 0x61021, 0xc};
...
TEST(EndToEndC, constant_merging) {
    ...
    std::vector<uint32_t> gold_standard = {0x50005, 0xc, 0x4000C,  0x3000D, 0x1000A, 0x2000B,0xc, 0x66, 0x42340000,  0x81823, 0x60843, 0xc};
...
TEST(EndToEndC, zero_assignment_removal) {
    ...
    std::vector<uint32_t> gold_standard = {0x20003, 0xc, 0x2000c, 0x1000a, 0xc,0x40021, 0xc};
...
TEST(EndToEndC, contiguos_array_allocation) {
    ...
    std::vector<uint32_t> gold_standard = {0x60004, 0xc, 0x30006, 0x20007, 0x10002, 0xc, 0x85855,0x40881, 0x26,0x2,0x608a1,0xc};
...
TEST(EndToEndC, constant_conversion) {
    ...
    std::vector<uint32_t> gold_standard = {0x50003, 0xC, 0x20003, 0x10002, 0xC, 0x26, 0x41700000, 0x46, 0xE, 0xC};
...
TEST(EndToEndC, constant_squaring) {
    ...
    std::vector<uint32_t> gold_standard = {0x50003, 0xc, 0x20006, 0x10005, 0xc, 0x26, 0x37A7C5AC, 0x46, 0x2FDBE6FE ,0xc};
