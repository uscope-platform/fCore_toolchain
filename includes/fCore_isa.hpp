...
namespace fcore{
    ...
    static std::map <hl_expression_node::expression_type_t, bool> fcore_implemented_operations {
            std::make_pair(hl_expression_node::expr_add, true),
            std::make_pair(hl_expression_node::expr_sub, true),
            std::make_pair(hl_expression_node::expr_mult, true),
            std::make_pair(hl_expression_node::expr_div, false),
            std::make_pair(hl_expression_node::expr_incr_pre, true),
            std::make_pair(hl_expression_node::expr_incr_post, true),
            std::make_pair(hl_expression_node::expr_decr_pre, true),
            std::make_pair(hl_expression_node::expr_decr_post, true),
            std::make_pair(hl_expression_node::expr_modulo, false),
            std::make_pair(hl_expression_node::expr_and_l, false),
            std::make_pair(hl_expression_node::expr_and_b, true),
            std::make_pair(hl_expression_node::expr_or_l, false),
            std::make_pair(hl_expression_node::expr_or_b, true),
            std::make_pair(hl_expression_node::expr_not_l, false),
            std::make_pair(hl_expression_node::expr_not_b, true),
            std::make_pair(hl_expression_node::expr_xor_b, true),
            std::make_pair(hl_expression_node::expr_lsh, false),
            std::make_pair(hl_expression_node::expr_rsh, false),
            std::make_pair(hl_expression_node::expr_eq, true),
            std::make_pair(hl_expression_node::expr_neq, true),
            std::make_pair(hl_expression_node::expr_neg, true),
            std::make_pair(hl_expression_node::expr_lt, true),
            std::make_pair(hl_expression_node::expr_gt, true),
            std::make_pair(hl_expression_node::expr_lte, true),
            std::make_pair(hl_expression_node::expr_gte, true),
            std::make_pair(hl_expression_node::expr_reciprocal, true),
            std::make_pair(hl_expression_node::expr_assign, false),
            std::make_pair(hl_expression_node::expr_call, false),
            std::make_pair(hl_expression_node::expr_fti, true),
            std::make_pair(hl_expression_node::expr_itf, true),
            std::make_pair(hl_expression_node::expr_satp, true),
            std::make_pair(hl_expression_node::expr_satn, true),
            std::make_pair(hl_expression_node::expr_popcnt, true),
            std::make_pair(hl_expression_node::expr_efi, true),
            std::make_pair(hl_expression_node::expr_abs, true),
            std::make_pair(hl_expression_node::expr_bset, true),
            std::make_pair(hl_expression_node::expr_bsel, true),
            std::make_pair(hl_expression_node::expr_nop, true),
            std::make_pair(hl_expression_node::expr_csel, true)
    };
