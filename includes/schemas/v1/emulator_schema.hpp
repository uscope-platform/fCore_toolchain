...
#ifndef FCORE_TOOLCHAIN_EMULATOR_SCHEMA_HPP
#define FCORE_TOOLCHAIN_EMULATOR_SCHEMA_HPP


#include <string>


const std::string emulator_schema_v1 = R"~(
{
...
#endif //FCORE_TOOLCHAIN_EMULATOR_SCHEMA_HPP
