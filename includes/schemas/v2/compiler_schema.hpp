...
#ifndef FCORE_TOOLCHAIN_COMPILER_SCHEMA_V2_HPP
#define FCORE_TOOLCHAIN_COMPILER_SCHEMA_V2_HPP


#include <string>


constexpr std::string_view compiler_schema_v2 = R"~(
{
...
#endif //FCORE_TOOLCHAIN_COMPILER_SCHEMA_V2_HPP
