...
namespace fcore{
    ...
    struct hl_ast_visitor_operations{
        ...
        > visit_conditional;
        std::function<
            std::shared_ptr<hl_ast_node> (const std::shared_ptr<hl_ast_loop_node> &cond)
        > visit_loop;
        std::function<
            std::shared_ptr<hl_ast_node> (const std::shared_ptr<hl_ast_operand> &cond)
        > visit_operand;
        std::function<
            std::vector<std::shared_ptr<hl_ast_node>> (const std::shared_ptr<hl_definition_node> & def)
        > visit_definition;
        std::function<
            std::vector<std::shared_ptr<hl_ast_node>>  (const std::shared_ptr<hl_expression_node> &cond)
        > visit_expression;
        std::function<
            std::vector<std::shared_ptr<hl_ast_node>> (const std::shared_ptr<hl_function_def_node> &cond)
        > visit_function_def;
        std::function<
            std::vector<std::shared_ptr<hl_ast_node>>  (const std::shared_ptr<hl_function_call_node> &cond)
        > visit_function_call;
    };
    ...
    private:
        ...
        std::vector<std::shared_ptr<hl_ast_node>> process_node(const std::shared_ptr<hl_expression_node> &cond);
