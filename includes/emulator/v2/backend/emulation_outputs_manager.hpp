...
namespace fcore::emulator_v2{
    ...
    public:
        ...
        void set_initial_values(const std::unordered_map<std::string,std::unordered_map<std::string, uint32_t>> &ivs){initial_values = ivs;}
    ...
    private:
        ...
        std::unordered_map<std::string,std::unordered_map<std::string, uint32_t>> initial_values;
    };
}
