...
fcore::bound_register_mapping_pass::apply_pass(std::shared_ptr<ll_instruction_node> element, uint32_t n) {
    ...
    switch (element->get_type()) {
        ...
        case isa_register_instruction:
            return process_reg_instr(std::static_pointer_cast<ll_register_instr_node>(element));
        case isa_conversion_instruction:
            return process_conv_instr(std::static_pointer_cast<ll_conversion_instr_node>(element));
        case isa_load_constant_instruction:
            return process_load_instr(std::static_pointer_cast<ll_load_constant_instr_node>(element));
        case isa_ternary_instruction:
            return process_ternary_instr(std::static_pointer_cast<ll_ternary_instr_node>(element));
        default:
...
std::shared_ptr<fcore::ll_instruction_node>
fcore::bound_register_mapping_pass::process_reg_instr(std::shared_ptr<ll_register_instr_node> node) {
...
std::shared_ptr<fcore::ll_instruction_node>
fcore::bound_register_mapping_pass::process_conv_instr(std::shared_ptr<ll_conversion_instr_node> node) {
    std::string raw_dest = node->get_destination()->get_name();
    int dest = std::stoi(raw_dest.substr(1, raw_dest.size()-1));
    node->get_destination()->set_bound_reg(dest);
...
std::shared_ptr<fcore::ll_instruction_node>
fcore::bound_register_mapping_pass::process_load_instr(std::shared_ptr<ll_load_constant_instr_node> node) {
...
std::shared_ptr<fcore::ll_instruction_node>
fcore::bound_register_mapping_pass::process_ternary_instr(const std::shared_ptr<ll_ternary_instr_node>& node) {
