...
fcore::code_block_inlining_pass::code_block_inlining_pass() : pass_base<hl_ast_node>("code block inlining pass"){

}

std::shared_ptr<fcore::hl_ast_node> fcore::code_block_inlining_pass::process_global(std::shared_ptr<hl_ast_node> element) {
...
fcore::code_block_inlining_pass::process_vector(const std::vector<std::shared_ptr<hl_ast_node>>& elements) {
...
std::vector<std::shared_ptr<fcore::hl_ast_node>> fcore::code_block_inlining_pass::process_element_by_type(std::shared_ptr<hl_ast_node> element) {
...
std::shared_ptr<fcore::hl_ast_node> fcore::code_block_inlining_pass::process_loop(std::shared_ptr<hl_ast_loop_node> element) {
...
fcore::code_block_inlining_pass::process_conditional(std::shared_ptr<hl_ast_conditional_node> element) {
...
std::shared_ptr<fcore::hl_ast_node> fcore::code_block_inlining_pass::process_definition(std::shared_ptr<hl_definition_node> element) {
...
std::vector<std::shared_ptr<fcore::hl_ast_node>> fcore::code_block_inlining_pass::process_expression(const std::shared_ptr<hl_expression_node>& expr) {
...
std::vector<std::shared_ptr<fcore::hl_ast_node>>
fcore::code_block_inlining_pass::process_code_block(const std::shared_ptr<hl_ast_node>& element) {
