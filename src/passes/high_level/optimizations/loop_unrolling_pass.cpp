...
namespace fcore{
    ...
    std::shared_ptr<hl_code_block> loop_unrolling_pass::process_global(std::shared_ptr<hl_code_block> element, const std::vector<std::shared_ptr<hl_definition_node>> &globals) {
