...
fcore::hl_function_def_node::hl_function_def_node() : hl_ast_node(hl_ast_node_type_function_def) {
    return_type = c_type_void;
}

void fcore::hl_function_def_node::set_parameters_list(std::vector<std::shared_ptr<hl_definition_node>> list) {
    parameters_list = std::move(list);
}

void fcore::hl_function_def_node::set_body(std::vector<std::shared_ptr<hl_ast_node>> b) {
    function_body = std::move(b);
}

void fcore::hl_function_def_node::set_return(std::shared_ptr<hl_ast_node> r) {
    return_expression = std::move(r);
}

void fcore::hl_function_def_node::set_name(std::string n) {
    name = std::move(n);
}

void fcore::hl_function_def_node::set_return_type(c_types_t ret_val) {
    return_type = ret_val;

}

std::vector<std::shared_ptr<fcore::hl_ast_node>> fcore::hl_function_def_node::get_body() {
    return function_body;
}

std::string fcore::hl_function_def_node::pretty_print() {
...
std::shared_ptr<fcore::hl_ast_node> fcore::hl_function_def_node::get_return() {
    return return_expression;
}

std::string fcore::hl_function_def_node::get_name() {
    return name;
}

nlohmann::json fcore::hl_function_def_node::dump() {
