...
bool fcore::hl_ast_node::is_terminal() {
    return false;
}

fcore::hl_ast_node::hl_ast_node(hl_ast_node_type_t t) {
    node_type = t;
}

fcore::c_types_t fcore::hl_ast_node::string_to_type(const std::string &t) {
...
bool
fcore::hl_ast_node::compare_content_by_type(const std::shared_ptr<hl_ast_node> &lhs, const std::shared_ptr<hl_ast_node> &rhs) {
...
std::string fcore::hl_ast_node::type_to_string(const c_types_t &t) {
...
std::shared_ptr<fcore::hl_ast_node> fcore::hl_ast_node::deep_copy(const std::shared_ptr<hl_ast_node> &node) {
    if(node == nullptr){
        return nullptr;
...
std::shared_ptr<fcore::hl_ast_node> fcore::hl_ast_node::deep_copy_expr(const std::shared_ptr<hl_ast_node> &node) {
...
std::shared_ptr<fcore::hl_ast_node> fcore::hl_ast_node::deep_copy_def(const std::shared_ptr<hl_ast_node> &node) {
...
std::shared_ptr<fcore::hl_ast_node> fcore::hl_ast_node::deep_copy_conditional(const std::shared_ptr<hl_ast_node> &node) {
...
std::shared_ptr<fcore::hl_ast_node> fcore::hl_ast_node::deep_copy_loop(const std::shared_ptr<hl_ast_node> &node) {
...
std::shared_ptr<fcore::hl_ast_node> fcore::hl_ast_node::deep_copy_function_def(const std::shared_ptr<hl_ast_node> &node) {
...
std::shared_ptr<fcore::hl_ast_node> fcore::hl_ast_node::deep_copy_operands(const std::shared_ptr<hl_ast_node> &node) {
...
std::shared_ptr<fcore::hl_ast_node> fcore::hl_ast_node::deep_copy_function_call(const std::shared_ptr<hl_ast_node> &node) {
...
std::shared_ptr<fcore::hl_ast_node> fcore::hl_ast_node::deep_copy_program_root(const std::shared_ptr<hl_ast_node> &node) {
...
std::shared_ptr<fcore::hl_ast_node> fcore::hl_ast_node::deep_copy_code_block(const std::shared_ptr<hl_ast_node> &node) {
...
bool fcore::hl_ast_node::compare_vectors(const std::vector<std::shared_ptr<hl_ast_node>> &lhs,
...
std::string fcore::hl_ast_node::pretty_print() {
...
nlohmann::json fcore::hl_ast_node::dump() {
...
std::vector<nlohmann::json> fcore::hl_ast_node::dump_array(const std::vector<std::shared_ptr<hl_ast_node>>& vect) {
...
nlohmann::json fcore::hl_ast_node::dump_by_type(const std::shared_ptr<hl_ast_node>& node) {
